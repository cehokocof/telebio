...
![Tests](https://img.shields.io/badge/tests-52%20passed-brightgreen?logo=pytest)
...
| ✅ **52 теста** | Полное покрытие: провайдеры, сервис Telegram, планировщик, конфиг, фабрика |
...
│
├── tests/                       # 52 теста (pytest + pytest-asyncio)
